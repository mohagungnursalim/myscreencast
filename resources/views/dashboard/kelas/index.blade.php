            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                  ...
                  @if ($errors->any())
                    ...
                    <button
                        class="modal-open bg-transparent border border-gray-500 hover:border-indigo-500 text-gray-500 hover:text-indigo-500 font-bold py-2 px-4 rounded-full mb-2">Buat Kelas</button>
                                                ...
                                                <div class="overflow-hidden">
                                                    <table class="min-w-full text-left text-sm font-light">
                                                        ...
                                                        <tbody class="font-normal">
                                                          ...
                                                          <td class="whitespace-nowrap px-6 py-4">
                                                            <img width="140px" class="" src="{{ asset('storage/' .$kls->thumbnail) }}" alt="{{ $kls->judul }}">
                                                          </td>
                                                          <td class="whitespace-nowrap px-6 py-4 ">
                                                            {{ $kls->deskripsi }}
                                                          </td>
                                                          ...
                                                          @endforeach
                                                            @else
                                                            <tr>
                                                              <td class="whitespace-nowrap px-6 py-4 text-center" colspan="5">Tidak ada data..</td>
                                                          </tr>
                                                            @endif
